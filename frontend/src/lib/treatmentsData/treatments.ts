export const treatments = [
	{
		...
		type: 'Non-surgical',
		description:
			'A skin resurfacing treatment that removes the outer layer of skin to reduce blemishes, wrinkles, and uneven tone.',
		image: '/treatmentImage1.png',
		doctors: 'Dr. Sophia Clark',
		about:
			"Microneedling is a non-surgical cosmetic procedure designed to stimulate collagen production and improve skin texture and tone. This treatment uses fine needles to create tiny, controlled micro-injuries on the skin's surface, triggering the body's natural healing response. As a result, new collagen and elastin fibers form, giving the skin a smoother, firmer, and more youthful appearance. It can help reduce the appearance of fine lines, wrinkles, acne scars, and improve overall skin quality.",
		process: [
			{
	...
	},
	{
		...
		about:
			"Laser Hair Removal is a popular non-invasive procedure that uses focused laser beams to destroy hair follicles, significantly reducing hair growth over time. It’s effective for most areas of the body and suitable for various skin types.",
		process: [
	...
	},
	{
		...
		about:
			"Rhinoplasty, or nose reshaping surgery, is performed to improve nasal appearance or function. It can address size, shape, bridge, nostrils, or breathing issues.",
		process: [
	...
	},
	{
		...
		doctors: 'Dr. Emma Lee',
		about:
			"Botox is a purified protein injection that temporarily reduces muscle activity, smoothing dynamic wrinkles such as crow’s feet and frown lines.",
		process: [
	...
	},
	{
		...
		about:
			"Lip Fillers are injectable treatments designed to add volume and definition to the lips using hyaluronic acid-based fillers.",
		process: [
	...
	},
	{
		...
		about:
			"Facelift surgery lifts and firms sagging facial tissues, restoring a more youthful contour to the face and neck.",
		process: [
	...
	},
	{
		...
		about:
			"Microdermabrasion exfoliates the skin using a diamond-tipped tool or crystals to improve tone and texture.",
		process: [
	...
	},
	{
		...
		about:
			"Hair transplantation restores hair growth by transferring follicles from a donor site to thinning or balding areas.",
		process: [
	...
	},
	{
		...
		about:
			"Dermal Fillers add volume and smooth out wrinkles and folds in the face, using safe injectable substances like hyaluronic acid.",
		process: [
