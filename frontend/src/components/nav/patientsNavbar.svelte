	...
	<div class="flex w-full flex-wrap items-center justify-between gap-2 sm:w-auto sm:justify-start">
		...
		<div class="relative hidden md:block">
			<button
				...
				class="hover:bg-opacity-70 btn-dropdown-color1 flex w-full items-center justify-between rounded-full px-3 py-2 text-xs font-medium md:text-xs lg:px-4 lg:py-2 lg:text-sm"
			>
				<span>Treatment</span>
				<svg
