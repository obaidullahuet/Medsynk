<script lang="ts">
    ...
    try {
        ...
        await updatePatient(id, formData); // <-- make sure updatePatient accepts FormData
...
{#if isLoading}
    <div class="min-h-screen bg-gradient-to-br from-[#dff6ff] via-white to-[#c7f0ff] flex items-center justify-center">
        <div class="text-center">
            ...
            <p class="text-gray-600 font-medium">Loading patient...</p>
        </div>
    </div>
{:else}
    <div class="min-h-screen bg-gradient-to-br from-[#dff6ff] via-white to-[#c7f0ff] py-12">
        <div class="mx-auto max-w-2xl px-6">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-600 mt-2">Update the patient's information</p>
            </div>
